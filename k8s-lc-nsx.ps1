...
#$script = "wget -P /tmp http://192.168.10.170/nsx-install-2.3.0 && chmod +x /tmp/nsx-install-2.3.0 &>> /tmp/k8s-master.log"
...
#$script = "wget -P /tmp http://192.168.10.170/nsx-install-2.3.0-join && chmod +x /tmp/nsx-install-2.3.0-join &>> /tmp/k8s-master.log"
